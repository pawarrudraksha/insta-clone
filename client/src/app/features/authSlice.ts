...
export const selectCreateUser = (state: RootState): CreateUser =>
  state.auth.createUser;
export const selectCreateUserOtp = (state: RootState): string =>
  state.auth.createUserOtp;
export const selectIsSignupFormOpen = (state: RootState): boolean =>
  state.auth.isSignupFormOpen;
export const selectIsBirthdayFormOpen = (state: RootState): boolean =>
  state.auth.isBirthdayFormOpen;
export const selectIsOtpFormOpen = (state: RootState): boolean =>
  state.auth.isOtpFormOpen;
export const {
  setCurrentUser,
  resetCurrentUser,
  setCreateUser,
