...
const addProfilePic = asyncHandler(
  async (req: AuthenticatedRequest, res: Response) => {
    ...
    res.status(200).json(new ApiResponse(200, updatedUser, "User updated s"));
  }
);
...
const getUserInfoByUsername = asyncHandler(
...
const searchUsers = asyncHandler(
  async (req: AuthenticatedRequest, res: Response) => {
    ...
    if (results.length < 1) {
      return res
        .status(204)
        .json(new ApiResponse(204, {}, "No results for search"));
    }
    res
      .status(200)
...
const getSuggestedUsers = asyncHandler(
  async (req: AuthenticatedRequest, res: Response) => {
    ...
    if (suggestions.length < 1) {
      return res
        .status(204)
        .json(new ApiResponse(204, {}, "No suggestions for search"));
    }
    res
      .status(200)
      .json(
